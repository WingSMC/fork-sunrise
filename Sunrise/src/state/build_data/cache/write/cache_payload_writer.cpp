...
bool payload_checksum(records::Domains domains, std::uint64_t& checksum) noexcept {
    ...
    return checksum_domain<records::NamedRecord>(domains.named, checksum)
           ...
           && checksum_domain<records::EntityNameRecord>(domains.entityNames, checksum)
           && checksum_domain<records::EntityFamilyRecord>(domains.entityFamilies, checksum)
           && checksum_domain<records::EntityRecord>(domains.installedEntities, checksum)
...
bool write_payload(HANDLE file, records::Domains domains) noexcept {
    return write_domain<records::NamedRecord>(file, domains.named)
           ...
           && write_domain<records::EntityNameRecord>(file, domains.entityNames)
           && write_domain<records::EntityFamilyRecord>(file, domains.entityFamilies)
           && write_domain<records::EntityRecord>(file, domains.installedEntities)
