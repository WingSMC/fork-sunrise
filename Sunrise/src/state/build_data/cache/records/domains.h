...
struct DomainCounts {
    ...
    std::size_t entityFamilies{};
    std::size_t installedEntities{};
...
struct MutableDomains {
    ...
    std::span<entities::Family> entityFamilies;
    std::span<entities::Entity> installedEntities;
...
struct Domains {
    ...
    std::span<const entities::Family> entityFamilies;
    std::span<const entities::Entity> installedEntities;
